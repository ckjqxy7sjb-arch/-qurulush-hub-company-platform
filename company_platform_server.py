...
SEED: dict[str, Any] = {
    ...
    "objects": [
        {
            "id": 1,
            "name": "Объект компании 1",
            "address": "Укажите адрес объекта",
            "stage": "В работе",
            "progress": 0,
            "docs": 0,
            "risk": "medium",
            "inspector": "Будет указан из уведомления",
            "status": "Ожидает уведомлений",
        },
        {
            "id": 2,
            "name": "Объект компании 2",
            "address": "Укажите адрес объекта",
            "stage": "В работе",
            "progress": 0,
            "docs": 0,
            "risk": "low",
            "inspector": "Будет указан из уведомления",
            "status": "Без активных уведомлений",
        },
    ],
    "requests": [
        {
            "id": "NTF-1001",
            "title": "Входящее уведомление: требуется ответ компании",
            "object": 1,
            "from": "sacc2 / Минстрой",
            "owner": "Главный инженер",
            "due": "18.09.2026",
            "status": "needs_company",
            "text": "Проверьте уведомление, назначьте ответственного и отправьте ответ с документом или комментарием.",
            "history": [],
        },
        {
            "id": "NTF-1002",
            "title": "Начисление к оплате",
            "object": 1,
            "from": "sacc2 / платежный контур",
            "owner": "Бухгалтер",
            "due": "20.09.2026",
            "status": "needs_company",
            "text": "Необходимо проверить основание начисления, оплатить и прикрепить подтверждение оплаты.",
            "history": [],
        },
        {
            "id": "NTF-1003",
            "title": "Замечание требует устранения",
            "object": 2,
            "from": "Инспектор",
            "owner": "Прораб",
            "due": "Сегодня",
            "status": "review",
            "text": "Назначьте исполнителя, приложите фото/документы устранения и отправьте подтверждение.",
            "history": [],
        },
    ],
    "documents": [
        {"id": "DOC-1", "title": "Ответ на уведомление", "object": 1, "owner": "Главный инженер", "status": "Нужно отправить", "due": "18.09.2026", "file": ""},
        {"id": "DOC-2", "title": "Подтверждение оплаты", "object": 1, "owner": "Бухгалтер", "status": "Нужна квитанция", "due": "20.09.2026", "file": ""},
        {"id": "DOC-3", "title": "Фото / акт устранения замечания", "object": 2, "owner": "Прораб", "status": "Нужно загрузить", "due": "Сегодня", "file": ""},
    ],
    "inspections": [],
    "tasks": [
        {
            "id": "TASK-1",
            "title": "Подготовить ответ на уведомление",
            "object": 1,
            "owner": "Главный инженер",
            "due": "18.09.2026",
            "status": "new",
            "priority": "high",
            "source": "NTF-1001",
            "text": "Проверить входящее уведомление, собрать документы и подготовить текст ответа.",
            "evidence": "",
            "history": [],
        },
        {
            "id": "TASK-2",
            "title": "Загрузить подтверждение оплаты",
            "object": 1,
            "owner": "Бухгалтер",
            "due": "20.09.2026",
            "status": "new",
            "priority": "high",
            "source": "NTF-1002",
            "text": "Провести оплату, указать номер платежа и загрузить квитанцию.",
            "evidence": "",
            "history": [],
        },
        {
            "id": "TASK-3",
            "title": "Устранить замечание на объекте",
            "object": 2,
            "owner": "Прораб",
            "due": "Сегодня",
            "status": "in_progress",
            "priority": "medium",
            "source": "NTF-1003",
            "text": "Организовать устранение, сделать фотофиксацию и отправить подтверждение.",
            "evidence": "",
            "history": [],
        },
    ],
    "reference": [],
    "money": [
        {"id": "PAY-1", "title": "Начисление по уведомлению NTF-1002", "object": 1, "amount": 0, "owner": "Бухгалтер", "status": "К оплате", "due": "20.09.2026"},
        {"id": "PAY-2", "title": "Штраф / предписание к проверке", "object": 2, "amount": 0, "owner": "Юрист / Бухгалтер", "status": "На проверке", "due": "Сегодня"},
    ],
    "team": [
        ...
        {"id": "USR-3", "name": "Бекматов Нурлан", "email": "foreman@company.kg", "role": "Прораб", "access": "Объект и уведомления", "objects": "Объект компании 1; Объект компании 2", "object_ids": [1, 2], "last": "вчера 18:10"},
        {"id": "USR-4", "name": "Абдиев Руслан", "email": "brigadier@company.kg", "role": "Бригадир", "access": "Исполнение задач", "objects": "Объект компании 2", "object_ids": [2], "last": "вчера 17:44"},
    ...
    "notifications": [
        {"time": "09:55", "from": "sacc2 / Минстрой", "title": "Новое уведомление", "text": "Поступило уведомление, требуется назначить ответственного и отправить ответ.", "urgent": True, "read": False},
        {"time": "09:52", "from": "Платежный контур", "title": "Есть начисление", "text": "Проверьте оплату, внесите номер платежа и прикрепите квитанцию.", "urgent": True, "read": False},
    ],
    "audit": [
        {"time": "09:55", "actor": "sacc2 / Минстрой", "event": "Получено входящее уведомление", "object": 1},
        {"time": "09:55", "actor": "Компания", "event": "Уведомление принято в работу", "object": 1},
    ],
}
